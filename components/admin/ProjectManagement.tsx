...
export function ProjectManagement() {
  ...
  const teamMembers: TeamMember[] = [
    { id: '1', name: 'Alex Martin', avatar: defaultAvatarAsset, role: 'Dev' },
    { id: '2', name: 'Sarah Chen', avatar: defaultAvatarAsset, role: 'Designer' },
    { id: '3', name: 'Mike Johnson', avatar: defaultAvatarAsset, role: 'Marketing' },
    { id: '4', name: 'Emma Wilson', avatar: defaultAvatarAsset, role: 'Content' },
    { id: '5', name: 'Tom Rodriguez', avatar: defaultAvatarAsset, role: 'SEO' }
  ];
